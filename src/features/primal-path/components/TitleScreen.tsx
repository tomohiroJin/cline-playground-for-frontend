...
export const TitleScreen: React.FC<Props> = ({ save, dispatch, playSfx }) => {
  ...
  return (
    <Screen $center>
      <canvas ref={canvasRef} aria-hidden="true" width={240} height={130} style={{ width: 480, height: 260, marginBottom: 4, imageRendering: 'pixelated' }} />
      <Title>原始進化録</Title>
      <div style={{ fontSize: 13, color: '#b89830', letterSpacing: 7, marginBottom: 2 }}>PRIMAL PATH</div>
      <Divider />
      <div style={{ fontSize: 13, color: '#605848', letterSpacing: 2 }}>文明を選ぶたびに、未来が変わる</div>
      ...
      {/* 音量設定 */}
      <div style={{ display: 'flex', gap: 16, marginTop: 10, fontSize: 11, color: '#605848', alignItems: 'center' }}>
        <span
