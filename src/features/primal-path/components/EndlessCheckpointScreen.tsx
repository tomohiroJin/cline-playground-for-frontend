  ...
  return (
    <Screen>
      ...
      <GamePanel style={{ padding: '10px 12px' }}>
        <div style={{ fontSize: 13, color: '#f0c040', marginBottom: 4, textAlign: 'center' }}>── 現在の戦績 ──</div>
      ...
      <GamePanel style={{ padding: '10px 12px' }}>
        <div style={{ fontSize: 13, color: '#f08050', marginBottom: 4, textAlign: 'center' }}>── 次のウェーブ ──</div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginTop: 10, alignItems: 'center' }}>
        ...
        <GameButton
          style={{ minWidth: 190, fontSize: 12, opacity: 0.85 }}
