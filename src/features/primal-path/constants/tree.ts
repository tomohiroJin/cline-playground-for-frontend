...
export const TREE: readonly TreeNode[] = Object.freeze([
  ...
  Object.freeze({ id: 'atk5', n: '始祖の力', d: '全ダメ+10%', c: 900, e: Object.freeze({ dM: 0.10 }), r: 'dmg1', t: 5, cat: 'atk' }),
  ...
  // Tier 6
  Object.freeze({ id: 'atk6', n: '天破の拳', d: 'ATK+6', c: 1500, e: Object.freeze({ bA: 6 }), r: 'atk4', t: 6, cat: 'atk' }),
  Object.freeze({ id: 'hp6', n: '世界樹の命', d: 'HP+80', c: 1500, e: Object.freeze({ bH: 80 }), r: 'hp5', t: 6, cat: 'hp' }),
  ...
  Object.freeze({ id: 'dmg2', n: '破壊衝動', d: '全ダメ+12%', c: 1700, e: Object.freeze({ dM: 0.12 }), r: 'atk5', t: 6, cat: 'atk' }),
  Object.freeze({ id: 'start3', n: '太古の記憶', d: '開始文明Lv3', c: 2000, e: Object.freeze({ sC: 1 }), r: 'start2', t: 6, cat: 'spc' }),
  // Tier 7
  Object.freeze({ id: 'atk7', n: '原始神の怒り', d: 'ATK+8', c: 3000, e: Object.freeze({ bA: 8 }), r: 'atk6', t: 7, cat: 'atk' }),
  Object.freeze({ id: 'hp7', n: '不滅の魂', d: 'HP+120', c: 3000, e: Object.freeze({ bH: 120 }), r: 'hp6', t: 7, cat: 'hp' }),
  ...
  // Tier 8
  Object.freeze({ id: 'atk8', n: '万物破壊', d: 'ATK+12 全ダメ+15%', c: 5000, e: Object.freeze({ bA: 12, dM: 0.15 }), r: 'atk7', t: 8, cat: 'atk' }),
  Object.freeze({ id: 'hp8', n: '始原の器', d: 'HP+180', c: 5000, e: Object.freeze({ bH: 180 }), r: 'hp7', t: 8, cat: 'hp' }),
