...
const assert = (cond: boolean, msg = 'Assertion failed'): void => { if (!cond) throw new Error(msg); };

export const Difficulty = {
  /** Beat length in ticks for a given loop (lower = faster) */
  beatLength(loop: number): number {
