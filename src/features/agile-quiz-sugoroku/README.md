...
ゲーム内の画像やガイド画面に登場する3キャラクター:

| キャラ | 名前 | 役職 | テーマカラー | 決め台詞 |
|--------|------|------|-------------|---------|
| 🐱 猫 | ネコ | フルスタックエンジニア | 青 (#4d9fff) | 「にゃるほど、こう書けばキレイに動くにゃ！」 |
| 🐶 犬 | イヌ | PO / スクラムマスター | 緑 (#34d399) | 「よし、今日のデイリーは15分で終わらせるワン！」 |
| 🐰 うさぎ | ウサギ | QAエンジニア | シアン (#22d3ee) | 「このエッジケース、見逃してないぴょん？」 |
...
| キャラクター | 5 | `aqs_char_{id}.webp` | GuideScreen TEAM（未生成・emoji フォールバック対応） |
