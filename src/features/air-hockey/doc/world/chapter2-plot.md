...
| 難易度 | Easy |
| 勝利スコア | 3 |
| 場面 | 大会1週間前、蒼風館の体育館に風見丘高校が練習試合に来訪 |
...
- アキラ「はい、お願いします！」
- ユウ（解説）「風見丘高校のソウタ選手。公式戦の経験はまだ浅いけど、楽しんでプレイするタイプだね」
...
- アキラ「…やってみなきゃ分からないでしょ！」
- ユウ（解説）「白波カナタ選手。碧波学院の2年生。データが少ないけど…変則的なプレイスタイルらしい」
...
| # | 名前 | 所属 | 役割 | 登場形態 |
|---|------|------|------|---------|
| 1 | 風早 リク | 天嶺高校 | レンの強さを示す引き立て役 | ストーリー上の言及 + 観客席から観戦 |
| 2 | 白波 カナタ | 碧波学院 | 2-3 の対戦相手（変則プレイの壁） | プレイアブル対戦 |
| 3 | 朝霧 シオン | 銀嶺学園 | 第3章への伏線キャラ | 観客席での一言のみ |
...
| 項目 | 第2章での役割 |
|------|-------------|
| 立ち位置 | 2-1 の練習試合相手。大会には風見丘高校代表として出場するが、1回戦で敗退 |
