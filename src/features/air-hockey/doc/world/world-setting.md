...
| `pillars` | Pillars | 柱状の障害物がある台。反射角を鍛える特訓用 |
| `zigzag` | Zigzag | ジグザグ配置の障害物がある台。変則的な軌道を学ぶ練習用 |
| `fortress` | Fortress | 破壊可能な障害物がある台。突破力と戦術を鍛える練習用 |
| `bastion` | Bastion | 複雑な障害物配置の台。高度な戦術判断を要求する上級者向け |
...
|------|------|
| 2026-03-11 | 初版作成 |
| 2026-03-11 | P0-05 整合性レビュー: フィールド一覧修正、5人目の名前更新 |
