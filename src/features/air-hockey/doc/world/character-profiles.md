...
| 服装 | 白いスポーツウェア + 銀色のライン（観戦時は暁光学園のジャージ） |
...
- すべての学校名（蒼風館高等学校、桜ヶ丘高校、翠嶺学園、黒鉄高校、翔陽高校、海星学院、暁光学園）は架空の学校名であり、実在する学校とは無関係
