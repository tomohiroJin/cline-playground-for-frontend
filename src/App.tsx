...
// フッターリンクの共通スタイル（下線スライドインエフェクト付き）
  ...
  return (
    <>
      ...
      <AppContainer>
        ...
        {!isFullScreen && (
          <Footer>
            <FooterNav aria-label="フッターナビゲーション">
            ...
            <SisterSiteRow>
              姉妹サイト:{' '}
              <a href="https://gallery.niku9.click/" target="_blank" rel="noopener noreferrer">
