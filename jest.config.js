module.exports = {
  ...
  testPathIgnorePatterns: ['/node_modules/', '/__tests__/test-helpers\\.ts$', '/__tests__/helpers/(?!.*\\.test\\.ts)', '/__tests__/mocks/', '/__tests__/builders/(?!.*\\.test\\.ts)', '<rootDir>/scripts/', '<rootDir>/e2e/'],
