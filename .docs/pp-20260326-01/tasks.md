...
- [x] モバイルでのタップ領域が最低 44px 確保されていることを確認
...
- [x] PC 大画面（1920×1080）での表示確認
- [x] PC 小画面（1366×768）での表示確認
- [x] タブレット（768×1024）での表示確認
- [x] モバイル（375×667 / iPhone SE 相当）での表示確認
- [x] モバイル（390×844 / iPhone 14 相当）での表示確認

### 5-3. 機能確認

- [x] ゲーム開始〜バトル〜進化の一連フロー動作確認
- [x] セーブ・ロードの動作確認（既存データとの互換性）
- [x] 音声の動作確認
- [x] パフォーマンス確認（フレームレート劣化がないか）
