...
| [07-image-assets.md](./specs/07-image-assets.md) | 画像アセット仕様・挿入箇所 |
...
| MVP2 | [mvp/02/](./mvp/02/) | 完了 |
| MVP3 | [mvp/03/](./mvp/03/) | 完了 |
| MVP4 | [mvp/04/](./mvp/04/) | 完了 |
...
- **MVP5**: 効果音、BGM、音量設定
- **5ステージ拡張**: 5ステージ構成、ストーリー進行、ステージ報酬、ミニボス・メガボス
...
- 全5ステージ構成（1プレイ 15〜40分）
- 操作は単純、判断は多い
- 職業（戦士/盗賊）による情報取得の差
- レベルアップ（最大Lv15）による成長選択
- ステージクリア時のボーナス報酬選択
- ストーリー進行と各ステージ固有の世界観
- 全5ステージ合計タイムによる5段階評価（S/A/B/C/D）
