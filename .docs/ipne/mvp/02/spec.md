...
#### 接触の扱い（重なり防止）
- 敵・プレイヤーは同一タイルに重ならない
- 敵がプレイヤータイルへ侵入を試みた場合は接触扱いでダメージ発生
- 敵は侵入せず元の位置に留まる
...
#### プレイヤーのノックバック
- 敵の接触攻撃を受けた際、敵から離れる方向に1タイル押し戻される
- 押し戻し先が壁や敵の場合はその場に留まる
