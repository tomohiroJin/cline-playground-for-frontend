...
| イベント | 効果音 | 特徴 |
|---------|--------|------|
| 被弾 | プレイヤーダメージ音 | 下降スウィープ |
| 攻撃命中 | 攻撃命中音 | 短いパルス |
| 通常敵撃破 | 敵撃破音 | 上昇スウィープ |
| ボス撃破 | ボス撃破音 | 勝利ファンファーレ風メロディ |
| 罠発動 | 罠発動音 | 警告感のある上昇音 |
| アイテム取得 | アイテム取得音 | 軽い上昇音 |
| 回復 | 回復音 | 柔らかい上昇音 |
| レベルアップ | レベルアップ音 | 達成感のあるメロディ |
| ゲームクリア | クリアジングル | 壮大なメロディ |
| ゲームオーバー | ゲームオーバージングル | 哀しみのメロディ |
...
| 表示位置 | 画面上部中央 |
| 表示 | 「x2」「x3」...「x10+」 |
| 演出強化 | コンボ数に応じてヒットエフェクトが1.2〜1.8倍増幅 |
| 最大コンボ | 表示上限なし |
...
| 画面 | BGM | 特徴 |
|------|-----|------|
| タイトル | タイトルBGM | 神秘的なメロディ（ループ） |
| ゲーム中 | ステージ別BGM | ステージごとに異なるメロディ（ループ） |
| ボス戦 | ボス戦BGM | 緊迫感のあるメロディ（ループ） |
| クリア | クリアジングル | 達成感（単発） |
| ゲームオーバー | ゲームオーバージングル | 哀しみ（単発） |
...
| 2 | 神秘・やや緊張 | triangle+sine | 中速 |
| 3 | 不安・緊張 | sawtooth+triangle | やや速い |
