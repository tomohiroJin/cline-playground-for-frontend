...
```json
{
  ...
  "logo": "https://play.niku9.click/icon-192.png",
  ...
  "itemListElement": [
    {
      "@type": "ListItem",
      "position": 1,
      "url": "https://play.niku9.click/puzzle",
      "name": "Picture Puzzle",
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "url": "https://play.niku9.click/air-hockey",
      "name": "Air Hockey",
...
```json
{
  "@context": "https://schema.org",
  "@type": "FAQPage",
  "@id": "https://play.niku9.click/about#faq",
  "mainEntity": [
    {
      "@type": "Question",
...
**対応パス:**
- `/` → `https://play.niku9.click/`
- `/puzzle` → `https://play.niku9.click/puzzle`
- `/about` → `https://play.niku9.click/about`
- その他すべてのルート
...
| WebSite | `https://play.niku9.click/#website` | `index.html`（静的） |
| VideoGame | `https://play.niku9.click/{path}#game` | `useGameStructuredData`（動的） |
| BreadcrumbList | `https://play.niku9.click/{path}#breadcrumb` | `useGameStructuredData`（動的） |
| ItemList | `https://play.niku9.click/#gamelist` | `useItemListSchema`（動的） |
| FAQPage | `https://play.niku9.click/about#faq` | `useFaqSchema`（動的） |
...
User-agent: *
Allow: /
Sitemap: https://play.niku9.click/sitemap.xml
...
- [Picture Puzzle](https://play.niku9.click/puzzle): 美しい画像を使ったクラシックなスライドパズル。難易度調整機能付き。
- [Air Hockey](https://play.niku9.click/air-hockey): リアルな物理演算で楽しむエアホッケー。
- [Racing Game](https://play.niku9.click/racing): スピード感あふれるレースゲーム。
- [Falldown Shooter](https://play.niku9.click/falling-shooter): 落下しながら敵を撃破するシューティングゲーム。
- [Labyrinth of Shadows](https://play.niku9.click/maze-horror): 暗闘の迷宮を探索するホラーアドベンチャー。
- [Non-Brake Descent](https://play.niku9.click/non-brake-descent): ブレーキなしで坂道を駆け下りるアクションゲーム。
- [Deep Sea Interceptor](https://play.niku9.click/deep-sea-shooter): 深海を舞台にしたシューティングゲーム。
- [IPNE](https://play.niku9.click/ipne): ターン制ローグライクRPG。
- [Agile Quiz Sugoroku](https://play.niku9.click/agile-quiz-sugoroku): アジャイル開発の知識を試すクイズすごろく。
- [迷宮の残響](https://play.niku9.click/labyrinth-echo): テキスト探索×判断×ローグライトRPG。
- [RISK LCD](https://play.niku9.click/risk-lcd): リスク管理をテーマにしたLCD風ストラテジーゲーム。
- [KEYS & ARMS](https://play.niku9.click/keys-and-arms): 鍵と武器を駆使するアクションRPG。
- [原始進化録 - PRIMAL PATH](https://play.niku9.click/primal-path): 三大文明を育て進化を重ねる自動戦闘ローグライト。

## サイト情報

- [サイトについて](https://play.niku9.click/about): Game Platform の概要、特徴、よくある質問。
- [プライバシーポリシー](https://play.niku9.click/privacy-policy): 個人情報の取り扱いについて。
- [利用規約](https://play.niku9.click/terms): サービスの利用条件。
- [お問い合わせ](https://play.niku9.click/contact): 連絡先情報。
